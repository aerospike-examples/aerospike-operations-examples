...
try:
    ...
    print("\n{}\nlist remove_all_by_value(VALUE, 3)\n{}".format(bins[0][1], bins[1][1]))
    # [1, 2, 3, 4, 3, 2, 1]
    # [3, 3]
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print("\n{}\nlist remove_all_by_value(INDEX, 3)\n{}".format(bins[0][1], bins[1][1]))
    # [1, 2, 3, 4, 3, 2, 1]
    # [2, 4]
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print(
        "\n{}\nlist remove_all_by_value(REVERSE_INDEX, 3)\n{}".format(
            bins[0][1], bins[1][1]
        )
    )
    # [1, 2, 3, 4, 3, 2, 1]
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print("\n{}\nlist remove_all_by_value(RANK, 3)\n{}".format(bins[0][1], bins[1][1]))
    # [1, 2, 3, 4, 3, 2, 1]
    # [4, 5]
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print(
        "\n{}\nlist remove_all_by_value(REVERSE_RANK, 3)\n{}".format(
            bins[0][1], bins[1][1]
        )
    )
    # [1, 2, 3, 4, 3, 2, 1]
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print("\n{}\nlist remove_all_by_value(COUNT, 3)\n{}".format(bins[0][1], bins[1][1]))
    # [1, 2, 3, 4, 3, 2, 1]
    # 2
    ...
    print("\nlist remove_all_by_value(VALUE, ['v2', *]): {}".format(bins[1][1]))
    # list_remove_all_by_value(VALUE, ['v2', *]): [['v2', 1], ['v2', 2]]
    print("list remove_all_by_value(COUNT, ['z']): {}".format(bins[2][1]))
    # list_remove_all_by_value(COUNT, ['z']): 0
    print("\nList after: {}".format(bins[3][1]))
