...
try:
    ...
    ops = [
        operations.write("l", sample),
        operations.read("l"),
        listops.list_remove_by_rank("l", 0, aerospike.LIST_RETURN_REVERSE_INDEX),
    ]
    key, metadata, bins = client.operate_ordered(key, ops)
    ...
    ops = [
        operations.write("l", sample),
        operations.read("l"),
        listops.list_remove_by_rank("l", 0, aerospike.LIST_RETURN_RANK),
    ]
    key, metadata, bins = client.operate_ordered(key, ops)
    ...
    ops = [
        operations.write("l", sample),
        operations.read("l"),
        listops.list_remove_by_rank("l", 0, aerospike.LIST_RETURN_REVERSE_RANK),
    ]
    key, metadata, bins = client.operate_ordered(key, ops)
    ...
    ops = [
        operations.write("l", sample),
        operations.read("l"),
        listops.list_remove_by_rank("l", 0, aerospike.LIST_RETURN_COUNT),
    ]
    key, metadata, bins = client.operate_ordered(key, ops)
    ...
    ops = [
        operations.write("l", sample),
        listops.list_remove_by_rank("l", 0, aerospike.LIST_RETURN_NONE),
        operations.read("l"),
    ]
    ...
    ops = [
        listops.list_remove_by_rank("l", -2, aerospike.LIST_RETURN_VALUE),
    ...
    ops = [
        listops.list_remove_by_rank("l", -1, aerospike.LIST_RETURN_NONE, ctx),
    ...
    try:
        ...
        key, metadata, bins = client.operate(
            key,
            [listops.list_remove_by_rank("l", 11, aerospike.LIST_RETURN_VALUE)],
        )
        print("\n{}".format(bins["l"]))
