...
try:
    # set the list, remove_by_value_interval(VALUE, 2, 4)
    ops = [
    ...
    print("\n{}\nlist remove_by_value_interval(VALUE, 2, 4): {}\n{}".format(bins[0][1], bins[1][1], bins[2][1]))
    # [1, 2, 3, 4, 5, 4, 3, 2, 1]
    # list remove_by_value_interval(VALUE, 2, 4): [2, 3, 3, 2]
    # [1, 4, 5, 4, 1]

    # set the list, remove_by_value_interval(INDEX, 2, 4)
    ops = [
        operations.write("l", [1, 2, 3, 4, 5, 4, 3, 2, 1]),
        operations.read("l"),
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print("\n{}\nlist remove_by_value_interval(INDEX, 2, 4): {}\n{}".format(bins[0][1], bins[1][1], bins[2][1]))
    # [1, 2, 3, 4, 5, 4, 3, 2, 1]
    # list remove_by_value_interval(INDEX, 2, 4): [1, 2, 6, 7]
    # [1, 4, 5, 4, 1]

    # set the list, remove_by_value_interval(REVERSE_INDEX, 2, 4)
    ops = [
        operations.write("l", [1, 2, 3, 4, 5, 4, 3, 2, 1]),
        operations.read("l"),
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print("\n{}\nlist remove_by_value_interval(REVERSE_INDEX, 2, 4): {}\n{}".format(bins[0][1], bins[1][1], bins[2][1]))
    # [1, 2, 3, 4, 5, 4, 3, 2, 1]
    # list remove_by_value_interval(REVERSE_INDEX, 2, 4): [7, 6, 2, 1]
    # [1, 4, 5, 4, 1]

    # set the list, remove_by_value_interval(RANK, 2, 4)
    ops = [
        operations.write("l", [1, 2, 3, 4, 5, 4, 3, 2, 1]),
        operations.read("l"),
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print("\n{}\nlist remove_by_value_interval(RANK, 2, 4): {}\n{}".format(bins[0][1], bins[1][1], bins[2][1]))
    # [1, 2, 3, 4, 5, 4, 3, 2, 1]
    # list remove_by_value_interval(RANK, 2, 4): [2, 3, 4, 5]
    # [1, 4, 5, 4, 1]

    # set the list, remove_by_value_interval(REVERSE_RANK, 2, 4)
    ops = [
        operations.write("l", [1, 2, 3, 4, 5, 4, 3, 2, 1]),
        operations.read("l"),
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print("\n{}\nlist remove_by_value_interval(REVERSE_RANK, 2, 4): {}\n{}".format(bins[0][1], bins[1][1], bins[2][1]))
    # [1, 2, 3, 4, 5, 4, 3, 2, 1]
    # list remove_by_value_interval(REVERSE_RANK, 2, 4): [3, 4, 5, 6]
    # [1, 4, 5, 4, 1]

    # set the list, remove_by_value_interval(NONE, 2, 4)
    ops = [
        operations.write("l", [1, 2, 3, 4, 5, 4, 3, 2, 1]),
        operations.read("l"),
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print("\n{}\nlist remove_by_value_interval(NONE, 2, 4)\n{}".format(bins[0][1], bins[1][1]))
    # [1, 2, 3, 4, 5, 4, 3, 2, 1]
    # list remove_by_value_interval(NONE, 2, 4)
    # [1, 4, 5, 4, 1]
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print(
        "\n{}\nlist remove_by_value_interval(VALUE, [23003, NIL], [25005, NIL]): {}\n{}".format(
            bins[0][1], bins[1][1], bins[2][1]
        )
    )
    # [[20000, 39.04], [21001, 39.78], [23003, 40.89], [24004, 40.93], [25005, 41.18], [26006, 40.07]]
    # list remove_by_value_interval(VALUE, [23003, NIL], [25005, NIL]): [[23003, 40.89], [24004, 40.93]]
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print(
        "\n{}\nlist remove_by_value_interval(VALUE, [23003, NIL, [25005, INF]): {}\n{}".format(
            bins[0][1], bins[1][1], bins[2][1]
        )
    )
    # [[20000, 39.04], [21001, 39.78], [23003, 40.89], [24004, 40.93], [25005, 41.18], [26006, 40.07]]
    # list remove_by_value_interval(VALUE, [23003, NIL, [25005, INF]): [[23003, 40.89], [24004, 40.93], [25005, 41.18]]
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print(
        "\n{}\nlist remove_by_value_interval(VALUE, [23003, INF], [25005, INF]): {}\n{}".format(
            bins[0][1], bins[1][1], bins[2][1]
        )
    )
    # [[20000, 39.04], [21001, 39.78], [23003, 40.89], [24004, 40.93], [25005, 41.18], [26006, 40.07]]
    # list remove_by_value_interval(VALUE, [23003, INF], [25005, INF]): [[24004, 40.93], [25005, 41.18]]
    ...
    key, metadata, bins = client.operate_ordered(key, ops)
    print(
        "\n{}\nlist remove_by_value_interval(INVERTED|NONE, [23003, NIL, [25005, INF])\n{}".format(
            bins[0][1], bins[1][1]
        )
    )
    # [[20000, 39.04], [21001, 39.78], [23003, 40.89], [24004, 40.93], [25005, 41.18], [26006, 40.07]]
    # list remove_by_value_interval(INVERTED|VALUE, [23003, NIL, [25005, INF])
